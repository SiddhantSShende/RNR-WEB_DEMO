...
import { 
  CheckCircle, Monitor, Shield, 
  Mail, Phone, User, Send, Home, ChevronRight, 
  Search, AlertTriangle, Code, Bug
} from 'lucide-react';
import { useTheme } from '../../../contexts/ThemeContext';
import Navigation from '../../Navigation';
import { Link } from 'react-router-dom';

const ThickClientVAPT: React.FC = () => {
  ...
  const keyFeatures = [
    {
      ...
      description: "Thorough evaluation of thick client applications including binary analysis, network communication, and local data storage"
    },
    {
      icon: Bug,
      title: "Vulnerability Identification",
      description: "Systematic identification of security flaws including authentication bypass, privilege escalation, and injection attacks"
    },
    {
      icon: Code,
      title: "Reverse Engineering",
      description: "Advanced reverse engineering techniques to analyze application logic and identify hidden security vulnerabilities"
    },
    {
      icon: Shield,
      title: "Security Hardening",
      description: "Detailed recommendations for securing thick client applications against identified threats and vulnerabilities"
    }
  ];
        ...
        <div className="pt-32 pb-8 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <Link to="/services/application-security" className={`transition-colors ${
                isDarkMode ? 'text-slate-400 hover:text-blue-400' : 'text-slate-600 hover:text-blue-600'
              }`}>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className={`text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed ${
                ...
                Comprehensive Vulnerability Assessment and Penetration Testing for thick client applications, 
                ensuring robust security through advanced testing methodologies and expert analysis.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className={`backdrop-blur-md border rounded-3xl p-12 shadow-2xl ${
              ...
              <div className="text-center mb-12">
                ...
                <p className={`text-lg ${
                  ...
                  Ready to secure your thick client applications? Contact our security experts today.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your thick client applications, security requirements, or questions about our penetration testing services..."
                  />
                </div>
...
export default ThickClientVAPT;
