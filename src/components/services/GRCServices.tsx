...
import { 
  Shield, Award, CheckCircle, Settings,
  ...
  const serviceCategories = [
    {
      ...
      description: "Comprehensive information security governance frameworks and strategic development",
      icon: Settings,
      services: [
        ...
        "Security Roles & Responsibilities Mapping"
      ],
      link: "/services/grc/governance-services"
    },
    {
      title: "Risk Management Services",
      description: "Enterprise-wide risk assessment and management solutions",
      icon: Shield,
      services: [
        "Enterprise Risk Assessment (IT & Cyber Risks)",
        "Risk Register Creation & Mitigation Planning",
        "Risk Treatment Plans & Residual Risk Analysis", 
        "Regulatory Gap Analysis & Remediation Planning"
      ],
      link: "/services/grc/risk-management-services"
    },
    {
      title: "Compliance & Audit Services",
      description: "Comprehensive compliance management and audit readiness services",
      icon: Award,
      services: [
        "ISO 27001, NIST, RBI Standards Compliance",
      ...
      link: "/services/grc/compliance-audit-services"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className={`inline-flex items-center px-4 py-2 rounded-full mb-6 ${
                ...
                <span className="font-medium">Governance, Risk & Compliance</span>
              </div>
              ...
              <p className={`text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed ${
                ...
                Comprehensive Governance, Risk & Compliance solutions to protect your organization 
                from regulatory, operational, and cybersecurity risks while ensuring business continuity.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
                ...
                Our GRC Service Categories
              </h2>
              <p className={`text-xl max-w-3xl mx-auto ${
                isDarkMode ? 'text-slate-300' : 'text-slate-600'
              }`}>
                Tailored solutions covering all aspects of governance, risk management, and compliance
              </p>
            </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 mb-6">
                        {category.services.map((service, serviceIndex) => (
                          <div key={serviceIndex} className={`p-4 rounded-lg border ${
                            isDarkMode 
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className={`text-xl ${
                ...
                Ready to strengthen your governance, risk, and compliance posture? 
